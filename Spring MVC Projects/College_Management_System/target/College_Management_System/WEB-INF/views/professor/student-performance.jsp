...
<body>
  <div class="container">
    <div class="d-flex justify-content-between align-items-center mb-4">
      ...
      <div>
        <a href="${pageContext.request.contextPath}/professor/dashboard" class="btn btn-secondary">🔙 Back</a>
        <a href="${pageContext.request.contextPath}/professor/logout" class="btn btn-danger">Logout</a>
      </div>
    </div>
